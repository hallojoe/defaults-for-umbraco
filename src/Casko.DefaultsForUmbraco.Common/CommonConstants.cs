namespace Casko.DefaultsForUmbraco.Common;

public static class CommonConstants
{
    public const string UmbracoServerRoleEnvironmentVariableName = "UMBRACO_SERVER_ROLE";
    public const string EnableForwardHeadersEnvironmentVariableName = "FORWARD_HEADERS_ENABLED";
