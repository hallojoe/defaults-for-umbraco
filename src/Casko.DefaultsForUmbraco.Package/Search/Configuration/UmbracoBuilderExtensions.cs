...
using Casko.DefaultsForUmbraco.Package.Search.Content;
using Casko.DefaultsForUmbraco.Package.Search.Controllers;
using Casko.DefaultsForUmbraco.Package.Search.Services;
...
public sealed class Search2ApiConfigureSwaggerGenOptions : IConfigureOptions<SwaggerGenOptions>
{
    public void Configure(SwaggerGenOptions options)
    {
        if (!options.SwaggerGeneratorOptions.SwaggerDocs.ContainsKey("search2"))
        {
            options.SwaggerDoc("search2", new OpenApiInfo
            {
                Title = "search2",
                Version = "1.0"
            });
        ...
        options.OperationFilter<Search2ApiHeadersOperationFilter>();
    }
}


public sealed class Search2ApiHeadersOperationFilter : IOperationFilter
{
    private const string ApiGroupName = "search2";
...
public static class UmbracoBuilderExtensions
{
    public static IUmbracoBuilder AddSearchServices(this IUmbracoBuilder builder)
    {
        ...
        builder.Services.ConfigureOptions<Search2ApiConfigureSwaggerGenOptions>();
