...
internal sealed class UrlNameContentIndexer(IDocumentUrlService documentUrlService) : IContentIndexer
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        foreach (var culture in effectiveCultures)
        {
            ...
            fields.Add(new IndexField(Constants.UrlName, value, culture!, null!));
        }
