...
namespace Casko.DefaultsFor.NemLogin3.Web.UI.Controllers
{
    ...
    public class IdPInitiatedController : Controller
    {
        ...
        public IdPInitiatedController(IWebHostEnvironment environment)
        {
        ...
        public IActionResult Initiate()
        {
            ...
            config.SigningCertificate = CertificateUtil.Load(environment.MapToPhysicalFilePath("itfoxtec.identity.saml2.testwebappcore_Certificate.pfx"), "!QAZ2wsx");
